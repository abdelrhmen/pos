            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <form action="{{ route('dashboard.user.index') }}" method="get">
                        ...
                        <div class="ro">
                            <div class="col-md-4">
                                <input type="text" name="search" class="form-control" placeholder="@lang('site.search')" value="{{ request()->search }}"id="">
                            </div>
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('users_create'))
                                    <a href="{{ route('dashboard.user.create') }}" class="btn btn-primary"><i
                                            class="fa fa-plus"></i>@lang('site.add')</a>
                                @else
                                    <a href="#" class="btn btn-primary disbled"><i
                                            class="fa fa-plus"></i>@lang('site.add')</a>
                                @endif
                            </div>
                        </div>
                    </form><!-- end of form -->
                </div> <!-- eond of box-header -->
