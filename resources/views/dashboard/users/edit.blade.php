    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ Route('dashboard.user.index') }}"><i class="fa fa-dashboard"></i>@lang('site.users')</a></li>
                                        ...
                                        <div class="tab-pane {{ $index == 0 ? 'active' : '' }}" id="{{ $model }}">
                                            ...
                                            @foreach ($maps as $index => $map)
                                                <label><input type="checkbox"
                                                        name="permissions[]" {{$user->hasPermission($model .'_' . $map) ? 'checked' : '' }} value="{{ $model . '_' . $map }}"> @lang('site.'. $map)
                                                    </label>
                                            @endforeach
